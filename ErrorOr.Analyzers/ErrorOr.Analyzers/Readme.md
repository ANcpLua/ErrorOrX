...
### ErrorOr.Analyzers.Sample
A project that references the sample analyzers. Note the parameters of `ProjectReference` in [ErrorOr.Analyzers.Sample.csproj](../ErrorOr.Analyzers.Sample/ErrorOr.Analyzers.Sample.csproj), they make sure that the project is referenced as a set of analyzers. 

### ErrorOr.Analyzers.Tests
