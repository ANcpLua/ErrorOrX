...
///     <c>[ErrorOrEndpoint]</c>, <c>[ProducesError]</c>, <c>[AcceptedResponse]</c>,
///     <c>[ReturnsError]</c>, and <c>[RouteGroup]</c> as compile-time-injected types in the
///     consumer's <c>ErrorOr</c> namespace. Must live with this generator (not
///     <c>OpenApiTransformerGenerator</c>) because <c>ForAttributeWithMetadataName</c> only
///     sees types injected by the same generator.
/// </summary>
