...
public sealed partial class ErrorOrEndpointGenerator
{
    ...
    {
        /// <summary>
        ///     Standard auto-generated header for source files.
        /// </summary>
        public static void Header(StringBuilder code)
        {
        ...
        /// <summary>
        ///     Emits a ProducesResponseTypeMetadata call for OpenAPI documentation.
        /// </summary>
        public static void ProducesMetadata(StringBuilder code, int statusCode, string? typeFqn, string contentType)
        {
            code.AppendLine(typeFqn is not null
                ? $"            .WithMetadata(new {WellKnownTypes.Fqn.ProducesResponseTypeMetadata}({statusCode}, typeof({typeFqn}), new[] {{ \"{contentType}\" }}))"
                : $"            .WithMetadata(new {WellKnownTypes.Fqn.ProducesResponseTypeMetadata}({statusCode}))");
        }
    }
    ...
    private static void EmitMapCall(StringBuilder code, in EndpointDescriptor ep, int index, int maxArity)
    {
        ...
        else if (!unionResult.CanUseUnion)
        {
            ...
            Emit.ProducesMetadata(code, successInfo.StatusCode,
            ...
            foreach (var statusCode in unionResult.ExplicitProduceCodes.AsImmutableArray().Distinct()
                         .OrderBy(static x => x))
                Emit.ProducesMetadata(code, statusCode,
        ...
        string returnTypeFqn, bool isAsync)
    {
        ...
        foreach (var (_, paramName) in validationParams)
        {
            ...
            BindingCodeEmitter.EmitValidationDictBuilder(
                ...
                keyExpr: "key", valueExpr: "vr.ErrorMessage ?? \"\"",
        ...
        Func<string, string> wrapReturn)
    {
        ...
        BindingCodeEmitter.EmitValidationDictBuilder(
            ...
            keyExpr: "e.Code", valueExpr: "e.Description",
            filterExpr: $"e.Type != {WellKnownTypes.Fqn.ErrorType}.Validation");
        code.AppendLine(
