...
internal static class Throw
{
    ...
    /// <summary>
    ///     Throws an <see cref="System.ArgumentException" /> if the argument's buffer size is less than the required buffer
    ///     size.
    /// </summary>
        ...
        if (argument is null)
            ...
            switch (argument)
            {
                case ICollection<T> collection:
                    if (collection.Count is 0) ArgumentException(paramName, "Collection is empty");

                    break;
                case IReadOnlyCollection<T> readOnlyCollection:
                    if (readOnlyCollection.Count is 0) ArgumentException(paramName, "Collection is empty");
    ...
    {
        if (argument is null) ArgumentNullException(paramName);
        ...
        string memberName = "")
    {
        ...
        if (member is null) ArgumentException(paramName, $"Member {memberName} of {paramName} is null");
    ...
    /// <remarks>
    ///     If the <paramref name="innerException" /> is not a <see langword="null" />, the current exception is raised in a
    ///     catch
    ...
    {
        if (argument is 0) ArgumentOutOfRangeException(paramName, "Argument is zero");
    ...
    {
        if (argument is 0U) ArgumentOutOfRangeException(paramName, "Argument is zero");
    ...
    {
        if (argument is 0L) ArgumentOutOfRangeException(paramName, "Argument is zero");
    ...
    {
        if (argument is 0UL) ArgumentOutOfRangeException(paramName, "Argument is zero");
    ...
    {
        if (argument is 0.0) ArgumentOutOfRangeException(paramName, "Argument is zero");
