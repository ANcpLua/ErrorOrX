...
|----------------------------------|---------|---------------------------------|
| ANcpLua.Roslyn.Utilities         | 1.33.0  | Incremental generator utilities |
| ANcpLua.Roslyn.Utilities.Testing | 1.33.0  | Generator testing framework     |
| ANcpLua.Analyzers                | 1.14.0  | Code quality analyzers          |
