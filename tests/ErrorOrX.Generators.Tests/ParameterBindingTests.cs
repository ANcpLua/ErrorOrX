...
public class ParameterBindingTests : GeneratorTestBase
{
    ...
    public async Task Multiple_Body_Sources_Emits_EOE006()
    {
        const string Source = """
                              ...
                              {
                                  [Post("/test")]
                                  public static ErrorOr<string> Handler([FromBody] Request1 r1, [FromBody] Request2 r2)
                                      => r1.A + r2.B;
                              }
    ...
    public async Task Invalid_FromRoute_Type_Emits_EOE010()
    {
        const string Source = """
                              ...
                              {
                                  [Get("/items/{id}")]
                                  public static ErrorOr<string> Handler([FromRoute] ComplexType id) => "test";
                              }
                              """;
    ...
    public async Task Invalid_FromHeader_Type_Emits_EOE014()
    {
        const string Source = """
                              ...
                              {
                                  [Get("/test")]
                                  public static ErrorOr<string> Handler([FromHeader] ComplexType header) => "test";
                              }
                              """;
