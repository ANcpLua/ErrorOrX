...
public class JsonContextTests
{
    ...
    public void ErrorOr_ShouldExist()
    {
        ...
        var errorOrType = errorOrAssembly.GetType("ErrorOr.ErrorOr`1");
        errorOrType.Should().NotBeNull("ErrorOr<T> should be defined in the ErrorOrX assembly");
    }
    ...
    public void Error_ShouldExist()
    {
        ...
        var errorType = errorOrAssembly.GetType("ErrorOr.Error");
        errorType.Should().NotBeNull("Error should be defined in the ErrorOrX assembly");
    }
    ...
    public void ErrorType_ShouldExist()
    {
        ...
        var errorTypeEnum = errorOrAssembly.GetType("ErrorOr.ErrorType");
        errorTypeEnum.Should().NotBeNull("ErrorType should be defined in the ErrorOrX assembly");
    }
