...
public static class Convert
{
    ...
    public static Task<ErrorOr<int>> ToIntAsync(string str)
    {
        return Task.FromResult(ToInt(str));
    }

    public static Task<ErrorOr<string>> ToStringAsync(int num)
    {
        return Task.FromResult(ErrorOrFactory.From(num.ToString()));
    }
}
