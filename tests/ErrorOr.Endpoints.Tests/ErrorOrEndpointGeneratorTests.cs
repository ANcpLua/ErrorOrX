...
public class ErrorOrEndpointGeneratorTests : GeneratorTestBase
{
    ...
    public void ErrorType_Failure_Maps_To_500_InternalServerError()
    {
        ...
        var errorMappingType = assembly.GetType("ErrorOr.Endpoints.Generators.ErrorMapping", true)!;
        var errorTypeEnum = assembly.GetType("ErrorOr.Endpoints.Generators.ErrorType", true)!;
        ...
        var failureValue = Enum.Parse(errorTypeEnum, "Failure");
        var result = method!.Invoke(null, [failureValue])!;
    ...
    public void ErrorType_Unexpected_Maps_To_500_InternalServerError()
    {
        ...
        var unexpectedValue = Enum.Parse(errorTypeEnum, "Unexpected");
        var result = method!.Invoke(null, [unexpectedValue])!;
    ...
    public void ErrorType_Maps_To_Correct_HttpStatus_Per_RFC9110(string errorTypeName, int expectedStatus)
    {
        ...
        var errorValue = Enum.Parse(errorTypeEnum, errorTypeName);
        var result = method!.Invoke(null, [errorValue])!;
    ...
    {
        var assembly = typeof(ErrorOrEndpointGenerator).Assembly;
        var builderType = assembly.GetType("ErrorOr.Endpoints.Generators.ResultsUnionTypeBuilder", true);
        var successKindType = assembly.GetType("ErrorOr.Endpoints.Generators.SuccessKind", true)!;
