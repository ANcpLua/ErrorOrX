...
public class ElseAsyncTests
{
    ...
    {
        // Arrange
        Error originalError = Error.Validation("Original.Error", "Original error description");
    ...
    public async Task CallingElseAsync_WithTaskValue_WhenIsError_ShouldReturnTaskValue()
    {
        ...
        // Act
        ErrorOr<string> result = await errorOrString.ElseAsync(Task.FromResult("fallback value"));
    ...
    public async Task CallingElseAsync_WithTaskError_WhenIsError_ShouldReturnTaskError()
    {
        // Arrange
        ErrorOr<string> errorOrString = Error.NotFound();
        Error expectedError = Error.Unexpected("Custom.Error", "Custom description");

        // Act
        ErrorOr<string> result = await errorOrString.ElseAsync(Task.FromResult(expectedError));
    ...
    public async Task CallingElseAsync_WithTaskError_WhenIsSuccess_ShouldReturnOriginalValue()
    {
        ...
        // Act
        ErrorOr<string> result = await errorOrString.ElseAsync(Task.FromResult(Error.Unexpected()));
    ...
    public async Task CallingElseAsync_WithErrorListFunc_WhenIsError_ShouldReturnErrors()
    {
        ...
        // Act
        ErrorOr<string> result = await errorOrString.ElseAsync(
            static _ => Task.FromResult<IReadOnlyList<Error>>(new List<Error>
            {
                Error.Validation("New.Error.One", "First"),
                Error.Validation("New.Error.Two", "Second"),
            }));
    ...
    public async Task CallingElseAsync_WithErrorListFunc_WhenIsSuccess_ShouldReturnOriginalValue()
    {
        ...
        // Act
        ErrorOr<string> result = await errorOrString.ElseAsync(
            static _ => Task.FromResult<IReadOnlyList<Error>>(new List<Error> { Error.Validation() }));
