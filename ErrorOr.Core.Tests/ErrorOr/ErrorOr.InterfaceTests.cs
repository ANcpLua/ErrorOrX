...
public class ErrorOrInterfaceTests
{
    ...
    public void AccessingIErrorOrErrors_WhenNoError_ShouldReturnNull()
    {
        ...
        // Act
        IReadOnlyList<Error>? errors = interfaceErrorOr.Errors;
    ...
    public void AccessingIErrorOrValue_WhenNoError_ShouldReturnValue()
    {
        ...
        // Act
        int value = interfaceErrorOr.Value;
    ...
    public void AccessingIErrorOrIsError_WhenNoError_ShouldReturnFalse()
    {
        ...
        // Act
        bool isError = interfaceErrorOr.IsError;
    ...
    {
        // Arrange
        Error error = Error.Validation("Test.Error", "Test error description");
    ...
    public void AccessingIErrorOrValue_WhenIsError_ShouldThrowInvalidOperationException()
    {
        ...
        // Act
        Func<int> act = () => interfaceErrorOr.Value;

        // Assert
        act.Should().ThrowExactly<InvalidOperationException>()
           .WithMessage("The Value property cannot be accessed when errors have been recorded. Check IsError before accessing Value.");
    }
    ...
    public void IErrorOr_WhenUsedPolymorphically_ShouldWorkCorrectly()
    {
        ...
        List<IErrorOr> errorOrList = new() { intErrorOr, stringErrorOr };
    ...
    public void IErrorOrGeneric_WhenAccessedThroughInterface_ShouldPreserveValue()
    {
        ...
        // Act
        TestPerson actualPerson = interfaceErrorOr.Value;
    ...
    {
        // Arrange
        Error sharedError = Error.Unauthorized("Auth.Failed", "Authentication failed");
    ...
    public void IErrorOrValue_WhenValueIsReferenceType_ShouldReturnSameReference()
    {
        ...
        // Act
        List<int> result = interfaceErrorOr.Value;
    ...
    public void IErrorOrErrors_WhenAccessedMultipleTimes_ShouldReturnConsistentResults()
    {
        ...
        // Act
        IReadOnlyList<Error>? errors1 = interfaceErrorOr.Errors;
        IReadOnlyList<Error>? errors2 = interfaceErrorOr.Errors;
    ...
    public void IErrorOr_WhenUsedWithResultTypes_ShouldWorkCorrectly()
    {
        ...
        // Act & Assert
        ((IErrorOr)successResult).IsError.Should().BeFalse();
        ((IErrorOr)createdResult).IsError.Should().BeFalse();
        ((IErrorOr)deletedError).IsError.Should().BeTrue();
        ((IErrorOr)updatedError).IsError.Should().BeTrue();
    }
