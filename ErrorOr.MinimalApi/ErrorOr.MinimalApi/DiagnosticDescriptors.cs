...
///     Focused on catching real errors, antipatterns, and AOT issues.
/// </summary>
/// <remarks>
///     Design principles:
///     - BCL handles OpenAPI metadata via Results union types - don't duplicate
///     - Focus on compile-time errors that would fail at runtime
///     - Warn about semantic misuse and AOT pitfalls
///     - Avoid over-engineering or pedantic warnings
///
///     Note: These descriptors are intentionally duplicated in ErrorOr.Http.Bcl.Analyzers/Descriptors.cs
...
{
    private const string Category = "ErrorOr.Http";
    ...
    public static readonly DiagnosticDescriptor NonStaticHandler = new(
        ...
        "Method '{0}' must be static. Instance methods cannot be used with ErrorOr.Http source generation.",
        Category,
        DiagnosticSeverity.Error,
        true);
