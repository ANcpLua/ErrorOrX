...
internal static class TypeExtensions
{
    ...
    public static bool TryGetRequiredAttribute(this ValidationAttribute[] attributes,
    ...
    public static List<Type> GetAllImplementedTypes(
        [DynamicallyAccessedMembers(DynamicallyAccessedMemberTypes.Interfaces)] this Type type)
    {
        ...
        foreach (var interfaceType in type.GetInterfaces()) implementedTypes.Add(interfaceType);
