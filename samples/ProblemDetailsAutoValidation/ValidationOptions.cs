...
public class ValidationOptions
{
    ...
    ///     if the type was found; otherwise, <see langword="null" />.
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if validation information was found for the specified type; otherwise,
    ///     <see langword="false" />.
    /// </returns>
    [Experimental("ASP0029", UrlFormat = "https://aka.ms/aspnet/analyzer/{0}")]
    ...
    ///     if validation information was found; otherwise, <see langword="null" />.
    /// </param>
    /// <returns>
    ///     <see langword="true" /> if validation information was found for the specified parameter; otherwise,
    ///     <see langword="false" />.
    /// </returns>
    [Experimental("ASP0029", UrlFormat = "https://aka.ms/aspnet/analyzer/{0}")]
